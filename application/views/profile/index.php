<div class="profile-page">
  ...
  <section class="profile-hero">
    ...
    <div class="profile-photo-wrap">
      <img src="<?= base_url(!empty($result['urlfiles']) ? 'uploads/propilpicture/' . $result['urlfiles'] : 'uploads/dummy/magikarp.jpeg'); ?>" class="profile-photo">
    </div>
    <!-- Panel Info -->
      ...
      <div class="row g-3">
        ...
        <div class="col-12 col-md-6">
          <div class="form-floating-soft">
            ...
            <input type="text" name="gender" class="form-control custom-input editable" value="<?php echo $result['gender'];?>" readonly>
          </div>
...
function toggleEdit() {
  ...
  if (isEditing) {
    ...
    btn.innerHTML = '<i class="bi bi-x me-1"></i>';
