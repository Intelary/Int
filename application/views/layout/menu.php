...
<nav class="navbar-floating fixed-bottom mb-4 mx-auto shadow-lg border">
  <div class="d-flex text-center align-items-center justify-content-between py-1 overflow-auto flex-nowrap">
    ...
    <!-- Blog -->
    <a href="<?php echo base_url('blog'); ?>" class="nav-link nav-item-float flex-fill <?php echo ($segment == 'blog') ? 'text-primary active' : 'text-secondary'; ?>">
    ...
    <!-- Pasien -->
    <a href="<?php echo base_url('patient'); ?>" class="nav-link nav-item-float flex-fill <?php echo ($segment == 'patient') ? 'text-primary active' : 'text-secondary'; ?>">
      <i class="bi bi-person-lines-fill fs-5"></i>
      <div class="nav-text">Pasien</div>
    </a>
    <!-- Darurat -->
    <a href="<?php echo base_url('darurat'); ?>" class="nav-link nav-item-float flex-fill <?php echo ($segment == 'darurat') ? 'text-danger active' : 'text-secondary'; ?>">
      <i class="bi bi-telephone-fill fs-5"></i>
      <div class="nav-text">Darurat</div>
    </a>
  </div>
</nav>